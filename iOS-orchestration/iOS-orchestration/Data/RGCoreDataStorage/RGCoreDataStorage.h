...
/**
 * DEVNOTE: This class came from the XMPPFramework Library used for XMPP.
 * I reused this class to simplify the persistence and use the features of the base CoreDataStorage that this class provides
 **/
...
@interface RGCoreDataStorage : NSObject {
@private
